...
@Component(immediate=true, managedservice="org.etri.slice.core")
@Instantiate
public class CoreConfigurator {

	private static Logger s_logger = LoggerFactory.getLogger(CoreConfigurator.class);		
	...
	public void updated(Dictionary props) throws ConfigurationException {
		...
		if (!pid.equals("org.etri.slice.core")) {
			return;
		}
		...
		try {
			...
			writer.close();
			s_logger.info("UPDATED: updated the core configuratiions");			
		} 
		catch (Throwable e) {
