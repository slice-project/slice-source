...
public class DeviceConfigurator {
	...
	private static Logger s_logger = LoggerFactory.getLogger(DeviceConfigurator.class);		
	...
	public void updated(Dictionary props) throws ConfigurationException {
		...
		if (!pid.equals("org.etri.slice.device")) {
			return;
		}
		...
		try {
			...
			writer.close();
			s_logger.info("UPDATED: updated the device configuratiions");			
		} 
		catch (Throwable e) {
